...
from crack_password import MD5me
...
def search_method_1_and_3(file_name, num_digits):
    ...
    number_of_words = len(words)
    print()
    print("Using method 3 with a list of "+str(number_of_words)+" words and "+str(num_digits)+" digits of numbers...")
...
def main(argv=None):
    ...
    # To test the code, change password0. This password is displayed
